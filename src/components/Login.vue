      ...
      <div v-if="page == 'signup'" class="column is-4 is-offset-4">
        ...
        <div class="box">
          <form @submit.prevent="signup">
            <div class="field">
              <div class="control">
                <input class="input" type="email" placeholder="Your Email" v-model="email" autofocus="" v-validate="'required|email'" name="email">
                <p class="help is-danger">{{ errors.first('email')}}</p>
              </div>
            </div>
            <div class="field">
              <div class="control">
                <input class="input" type="text" placeholder="Choose a username" v-model="username" autofocus="" v-validate="'required'" name="username">
                <p class="help is-danger">{{ errors.first('username')}}</p>
              </div>
            </div>
            <div class="field">
              <div class="control">
                <input class="input" type="password" placeholder="Choose a password" v-model="password" autofocus="" v-validate="'required|min:6'" name="password">
